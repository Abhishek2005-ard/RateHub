    ...
    <section className="relative pt-12 pb-16 md:pt-20 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-2.5 px-4 py-3 bg-slate-950/80 border-b border-slate-800">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-2 text-xs font-mono text-slate-400 flex items-center gap-1.5 truncate">
                ...
                <span className="truncate">StoreRatingCard.jsx</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar w-full sm:w-auto justify-between sm:justify-end">
              ...
              <button
                onClick={handleCopy}
                className="p-1.5 sm:px-2.5 sm:py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-slate-300 hover:text-white transition-colors border border-slate-700/60 flex items-center gap-1.5 text-xs font-mono shrink-0 min-h-[36px]"
          ...
          {/* Terminal Body */}
          <div className="p-4 sm:p-6 bg-slate-950/90 font-mono text-xs sm:text-sm overflow-x-auto text-slate-200 no-scrollbar">
          ...
          <div className="p-4 sm:p-6 bg-slate-900 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
